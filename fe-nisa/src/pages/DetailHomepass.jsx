        ...
        <div className="border-b border-gray-900/10 pb-12">
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <input type="text" id="full_name_pic" name="full_name_pic" value={data.full_name_pic} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>

            <div className="sm:col-span-1">
              <label htmlFor="id" className="block text-sm font-medium leading-6 text-gray-900">Ticket:</label>
              <div className="mt-2">
                <input type="text" id="id" name="id" value={data.id} readOnly className="block w-full pl-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="submission_from" name="submission_from" value={data.submission_from} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="submission_from" name="submission_from" value={data.request_source} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="submission_from" name="submission_from" value={data.customer_cid} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="mt-2">
              <input type="text" id="coordinate_point" name="coordinate_point" value={data.coordinate_point} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="response_hpm_location" name="response_hpm_location" value={data.response_hpm_location} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="mt-2">
              <input type="text" id="response_hpm_source" name="response_hpm_source" value={data.response_hpm_source} readOnly className="block w-full pl-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <textarea type="text" id="current_address" name="current_address" value={data.current_address} readOnly rows="3" className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
            </div>
          </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <textarea  type="text" id="destination_address" name="destination_address" value={data.destination_address} readOnly rows="3" className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
            </div>
          </div>
...
<div className="col-span-3">
  ...
  <div className="relative inline-block group flex items-center space-x-2">
    <input 
      ...
      value={data.photo_old_fat_url} 
      readOnly 
      className="block w-full rounded-md pl-1 border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" 
    />
    <button 
      type="button"
      ...
      <div className="flex-grow overflow-auto">
        <img src={imageSrc} alt="Modal" className="w-full h-auto object-contain" />
          ...
          <div className="sm:col-span-4">
            ...
            <div className="mt-2">
              <input  type="text" id="request_purpose" name="request_purpose" value={data.request_purpose} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input  type="email" id="email_address" name="email_address" value={data.email_address} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input type="text" id="response_hpm_timestamp" name="response_hpm_timestamp" value={data.response_hpm_timestamp ? formatDate(data.response_hpm_timestamp) : ''} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
          ...
          <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="hpm_check_result" name="hpm_check_result" value={data.hpm_check_result} readOnly className="block w-full pl-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
          </div>
          ...
          <div className="sm:col-span-3">
            ...
            <div className="mt-2">
              <input type="text" id="hpm_pic" name="hpm_pic" value={data.hpm_pic} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2">
              <input  type="text" id="homepass_id" name="homepass_id" value={data.homepass_id} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2">
              <input type="text" id="home_id_status" name="home_id_status" value={data.home_id_status} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="mt-2">
              <input type="text" id="network"  name="network" value={data.network} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="sm:col-span-4">
            ...
            <div className="mt-2">
              <input id="remarks" name="remarks" value={data.remarks} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
          </div>
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <textarea id="notes_recommendations" name="notes_recommendations" value={data.notes_recommendations} readOnly rows="3" className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
            </div>
          </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <input type="text" id="status" name="status" value={data.status} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              <div className="mt-2">
                <input type="text" id="completion_date" name="completion_date" value={data.completion_date ? formatDate(data.completion_date) : ''} readOnly className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
              </div>
            </div>
{/* dari sini */}
...
{showSurveyOpsFields && (
  ...
  <div className="relative inline-block group flex items-center space-x-2">
    <input 
      ...
      value={data.video_survey_ops || ''} 
      readOnly 
      className="block w-full pl-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" 
    />
    <button 
      type="button"
      onClick={() => openVideoModal(data.video_survey_ops)}
      className="px-4 py-1 text-lg font-medium bg-[#662b81] text-white rounded-lg cursor-pointer"
    >
      Video
    </button>
      ...
      <div className="flex-grow overflow-auto">
        <video src={videoSrc} controls className="w-full h-auto" />
                ...
                <div className="col-span-full">
                  ...
                  <div className="mt-2">
                    <textarea id="notes_survey_ops" name="notes_survey_ops" value={data.notes_survey_ops || ''} readOnly rows="3" className="block pl-1 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                  </div>
                </div>
                </>
            )}
